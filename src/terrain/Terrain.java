...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, TerrainTexturePack texturePack, TerrainTexture blendMap, RawModel terrain) {
		this.texturePack = texturePack;
		this.blendMap = blendMap;
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
	...
	public float genHeightOfTerrain(float worldX, float worldZ) {
